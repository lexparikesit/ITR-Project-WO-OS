...
"[project]/node_modules/@mantine/hooks/esm/use-debounced-value/use-debounced-value.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function useDebouncedValue(value, wait, options = {
    leading: false
}) {
    const [_value, setValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(value);
    ...
    const cancel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>window.clearTimeout(timeoutRef.current), []);
...
"[project]/node_modules/@mantine/hooks/esm/use-local-storage/create-storage.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createStorage(type, hookName) {
    ...
    return function useStorage({ key, defaultValue, getInitialValueInEffect = true, sync = true, deserialize = deserializeJSON, serialize = (value)=>serializeJSON(value, hookName) }) {
        const readStorageValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((skipStorage)=>{
            let storageBlockedOrSkipped;
            try {
                storageBlockedOrSkipped = "undefined" === "undefined" || !(type in window) || window[type] === null || !!skipStorage;
            } catch (_e) {
        ...
        const [value, setValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(readStorageValue(getInitialValueInEffect));
        const setStorageValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((val)=>{
        ...
        const removeStorageValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
            removeItem(key);
            window.dispatchEvent(new CustomEvent(eventName, {
                detail: {
                    key,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$window$2d$event$2f$use$2d$window$2d$event$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWindowEvent"])("storage", (event)=>{
            if (sync) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$window$2d$event$2f$use$2d$window$2d$event$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWindowEvent"])(eventName, (event)=>{
            if (sync) {
...
function readValue(type) {
    ...
    return function read({ key, defaultValue, deserialize = deserializeJSON }) {
        let storageBlockedOrSkipped;
        try {
            storageBlockedOrSkipped = "undefined" === "undefined" || !(type in window) || window[type] === null;
        } catch (_e) {
            storageBlockedOrSkipped = true;
        }
        if (storageBlockedOrSkipped) {
...
"[project]/node_modules/@mantine/hooks/esm/use-local-storage/use-local-storage.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$local$2d$storage$2f$create$2d$storage$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mantine/hooks/esm/use-local-storage/create-storage.mjs [app-ssr] (ecmascript)");
'use client';
;
function useLocalStorage(props) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$local$2d$storage$2f$create$2d$storage$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStorage"])("localStorage", "use-local-storage")(props);
}
const readLocalStorageValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$local$2d$storage$2f$create$2d$storage$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["readValue"])("localStorage");
;
 //# sourceMappingURL=use-local-storage.mjs.map
}),
"[project]/node_modules/@mantine/hooks/esm/use-timeout/use-timeout.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useTimeout(callback, delay, options = {
    ...
    const timeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((...args)=>{
...
//# sourceMappingURL=node_modules_5f797e12._.js.map